...
for iCase in range(1, 5):
    ...
    aSlope_ladder = np.full(nCell_ladder, np.nan)
    ...
    for i in range(nCell_ladder-2, -1, -1):
        ...
        aSlope_ladder[i] = aSlope[index0]

    aX_all.append(aCellDistance_unstructured)
    aY_all.append(aSlope_ladder)
...
sLabel_y = r'Slope (ratio)'
sFilename_out = '/qfs/people/liao313/workspace/python/liao-2025_flowdirection_cgs/figures/ladderplot_slope.png'
