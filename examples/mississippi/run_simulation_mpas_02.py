...
#===================================
sFilename_configuration_in = realpath( sPath_parent +  '/data/mississippi/input/pyhexwatershed_mississippi_mpas_02.json' )
...
if iFlag_visualization == 1:
    ...
    sTitle = 'Hybrid stream burning and priority-flood'
    #oPyhexwatershed._animate(sFilename, iFlag_type_in =1,iFigwidth_in=10, iFigheight_in=7, sTitle_in = sTitle)
